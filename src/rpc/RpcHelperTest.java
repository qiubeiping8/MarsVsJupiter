...
public class RpcHelperTest {
    ...
    public void testGetJSONArray() throws JSONException {
        ...
        Item one = new ItemBuilder().setItemId("one").setRating(5.00).setCategories(category).setLongitude(33.33).build();
        Item two = new ItemBuilder().setItemId("two").setRating(5.00).setCategories(category).setLongitude(33.33).build();
